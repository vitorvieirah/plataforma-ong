...
public class OngController {
    ...
    @GetMapping(value = "/consultar-por-nome/{nome}")
    public ResponseEntity<List<OngDto>> consultarPorNome(@PathVariable("nome") String nome){
        return ResponseEntity.ok(ongService.consultarPorNome(nome));
    }
